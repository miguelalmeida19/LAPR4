...
public class SurveyAnswerServer extends Thread {
    ...
    public SurveyAnswerServer(Socket client) {
    ...
    public void sendResponse(int statusCode, String responseString, boolean isFile) throws Exception {
        ...
        if (isFile) {
            ...
            responseString = SurveyAnswerServer.HTML_START + responseString + SurveyAnswerServer.HTML_END;
